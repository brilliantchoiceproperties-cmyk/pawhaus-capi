...
const ROOM_GALLERIES = {
  ...
  monolith: [
    "/brand/monolith-mirror-couple.webp",  // LEAD — mirror cabin lakefront, couple, two dogs at golden hour
    "/brand/monolith-hottub.webp",         // wood-fired hot tub + fire pit + couple + dog
