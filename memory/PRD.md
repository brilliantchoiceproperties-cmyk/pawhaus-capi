...
- ✅ **Room Catalog v2 + Dog Difference Section (2026-02-16, polished 2026-02-16)** — Major room/pricing restructure with later naming revert:
   ...
   - Pytest: 41/41 tests pass (catalog rename, pricing, alias removed, cap with TTL, inventory endpoint). Frontend testing agent 100% — 5 dog difference cards, admin widget renders, full Stripe regression for both SKU prices.
